...
export const CLIENT = {
  ...
  PROPOSER: {
    ...
    myRequestsPage: '/my-open-jobs/:templateId/:startingDateAndTime/:createdAt',
    dynamicMyRequestsPage: (templateId, startingDateAndTime, createdAt) =>
      `/my-open-jobs/${templateId}/${startingDateAndTime}/${createdAt}`,
