...
export default class TaskerMyDisputedBidHouseCleaningSummary extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    if (!bid || !job) {
      return <div>TaskerMyDisputedBidHouseCleaningSummary is missing properties</div>;
    }
