...
const initializeJobImgUploaderWidget = (resp) => {
  window.BidOrBoo = window.BidOrBoo ? window.BidOrBoo : {};
  window.BidOrBoo.getJobImgUploaderWidget = window.BidOrBoo.getJobImgUploaderWidget
    ...
    : (
        ...
        const uploadPreset = `${process.env.REACT_APP_CLOUDINARY_PRESET}`;
        const apiKey = `${process.env.REACT_APP_CLOUDINARY_KEY}`;
        if (!window.BidOrBoo.getJobImgUploaderWidget.widget) {
          window.BidOrBoo.getJobImgUploaderWidget.widget = window.cloudinary.createUploadWidget(
            {
              uploadSignature: (callback, paramsToSign) => {
                axios
                  .get(ROUTES.API.UTILS.GET.signCloudinaryRequest, {
              ...
              text: {
                en: {
                  ...
                  local: {
                    main_title: 'BidOrBoo upload job pic',
                  },
                },
              },
            },
        ...
        return window.BidOrBoo.getJobImgUploaderWidget.widget;
      };
};
