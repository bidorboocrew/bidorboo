  ...
  handleSendNewCode = async () => {
    this.setState({ isResendingVCode: true }, async () => {
      try {
        ...
        // some alert
        alert(
          'Unable to verify your email, please click the chat button in the footer, or contact us bidorboo@bidorboo.com to resolve this',
        );
        this.setState({ isResendingVCode: false, inputCodeContent: '' });
      }
    });
  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="help">
          *Check inbox/junk folders for an email from bidorboo@bidorboo.com
        </div>
        <br />
      </div>
    );
