        ...
        <div style={{ height: 'auto' }} className="card disabled">
          ...
          <div className="card-content">
            ...
            <div style={{ marginBottom: 6 }}>
              ...
              <div className="is-size-6 has-text-weight-bold">{`${bidAmount} ${bidCurrency}`}</div>
            </div>
            <div style={{ marginBottom: 6 }}>
              <div className="is-size-7">My Bid Status :</div>
              <div className="is-size-6 has-text-weight-bold">Awarded</div>
            </div>
            ...
            <div className="modal is-active">
              ...
              <div className="modal-card">
                <header className="modal-card-head">
                  <div className="modal-card-title">Congratulations</div>
                </header>
