...
UserSchema.virtual('disabledReasonMsg').get(function() {
  ...
  return stripeConnect && stripeConnect.requirements && stripeConnect.requirements.disabled_reason
    ? disabledReasonDisplayMsg[stripeConnect.requirements.disabled_reason]
    : '';
});
