...
const JobSchema = new Schema(
  {
    ...
    processedPayment: {
      ...
      bidderPayout: { type: Number, required: true, min: 0, max: 10000 },
      platformCharge: { type: Number, required: true, min: 0, max: 10000 },
      proposerPaid: { type: Number, required: true, min: 0, max: 10000 },
      bidderStripeAcc: { type: String, required: true },
      refund: {
        amount: { type: Number, required: true, min: 0, max: 10000 },
